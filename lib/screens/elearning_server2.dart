...
//
// class ElearningServer2Screen extends StatelessWidget {
//   final bool isDesktopView;
//
//   const ElearningServer2Screen({super.key, required this.isDesktopView});
//
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       body: WebView(
//         initialUrl: 'https://e-learning.unpam.ac.id/',
...
class ElearningServer2Screen extends StatefulWidget {
  final bool isDesktopView;

  const ElearningServer2Screen({super.key, required this.isDesktopView});

  @override
  ElearningServer2ScreenState createState() => ElearningServer2ScreenState();
}

class ElearningServer2ScreenState extends State<ElearningServer2Screen> {
